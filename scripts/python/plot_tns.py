...
filename = './output/sta_output/sta_tns.txt'
lib_files = []
worst_slacks = []
...
plt.ylabel('Total Negative Slack')
plt.title('Total Negative Slack Values for Different Library Files')
plt.tight_layout()
...
plt.savefig('./session15/TNS.png', dpi=300)
