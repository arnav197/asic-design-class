...
filename = './output/sta_output/sta_worst_max_slack.txt'
lib_files = []
worst_slacks = []
...
plt.ylabel('Worst Setup Slack')
plt.title('Worst Setup Slack Values for Different Library Files')
plt.tight_layout()
...
plt.savefig('./session15/WSS.png', dpi=300)
