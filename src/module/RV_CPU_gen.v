...
wire clkP_CPU_rs2_valid_a2 ;
   ...
   //
      ...
      // Staging of $clk_arn.
      always @(posedge clk) CPU_clk_arn_a1 <= CPU_clk_arn_a0;
      always @(posedge clk) CPU_clk_arn_a2 <= CPU_clk_arn_a1;
      always @(posedge clk) CPU_clk_arn_a3 <= CPU_clk_arn_a2;
      always @(posedge clk) CPU_clk_arn_a4 <= CPU_clk_arn_a3;
      always @(posedge clk) CPU_clk_arn_a5 <= CPU_clk_arn_a4;
